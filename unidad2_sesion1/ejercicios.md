...
### Metadata
- **Duración estimada**: 30 minutos (tarea para casa)
...
<details>
<summary>Ver solución Ejercicio 1 - Análisis de Componentes</summary>

### Prompt A - Análisis

| Componente | Presente | Contenido |
|------------|----------|-----------|
| Rol | Si | Experto en marketing digital especializado en startups |
| Contexto | Si | Startup de software de gestión, nueva funcionalidad |
| Tarea | Si | Escribir 3 posts para LinkedIn |
| Formato | Si | 100-150 palabras, emoji, CTA |
| Restricciones | Si | No competidores, no jerga técnica |
| Ejemplos | No | - |
| **Evaluación** | **8/10** | Muy completo, podría beneficiarse de un ejemplo |
...
| Rol | No | - |
| Contexto | No | - |
| Tarea | Parcial | "Ideas para mejorar" (muy vago) |
| Formato | No | - |
| Restricciones | No | - |
| Ejemplos | No | - |
| **Evaluación** | **2/10** | Demasiado vago para ser útil |
...
| Rol | No | - |
| Contexto | No | - |
| Tarea | Si | Traducir y formalizar |
| Formato | No | - |
| Restricciones | No | - |
| Ejemplos | Si | El texto a traducir |
| **Evaluación** | **5/10** | Funcional pero podría ser más específico |

</details>

<details>
<summary>Ver solución Ejercicio 5 - Anti-patrones</summary>

### Prompt 1
**Anti-patrón:** Sobrecarga de instrucciones, falta de estructura
**Corrección:**
```
Revisa el siguiente código Python e identifica:
1. Errores de sintaxis
2. Errores lógicos
3. Sugerencias de mejora

Para cada problema encontrado, indica la línea y la solución.
...
### Prompt 2
**Anti-patrón:** Instrucciones contradictorias ("detallado pero breve")
**Corrección:**
```
Escribe un artículo sobre inteligencia artificial.
- Longitud: 500-700 palabras
- Nivel: Introductorio
- Incluir: definición, 3 aplicaciones prácticas, perspectivas futuras
```

### Prompt 3
**Anti-patrón:** Asumir contexto inexistente
**Corrección:**
```
En nuestra conversación anterior, estábamos [describir tarea específica].
El último punto fue [describir dónde quedamos].
Continúa desde ahí con [siguiente paso específico].
```

### Prompt 4
**Anti-patrón:** Instrucciones contradictorias + solicitud potencialmente problemática
**Corrección:**
```
Actúa como un consultor de ciberseguridad.
Explica las mejores prácticas de penetration testing ético, incluyendo:
- Metodologias estándar (OWASP, PTES)
- Herramientas legales comunes
- Importancia de autorización escrita
- Proceso de reporte de vulnerabilidades
```

### Prompt 5
**Anti-patrón:** Demasiado vago
**Corrección:**
```
Proporciona información sobre [tema específico].
...
Formato: Lista con bullets, máximo 200 palabras.
```
